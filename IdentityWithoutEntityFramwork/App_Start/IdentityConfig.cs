...
using IdentityWithoutEntityFramwork.Models;
using IdentityWithoutEntityFramwork.Service;
...
namespace IdentityWithoutEntityFramwork
{
    ...
    public class IdentityUserManager : UserManager<IdentityUser, Guid>
    {
        ...
        public static IdentityUserManager Create(IdentityFactoryOptions<IdentityUserManager> options, IOwinContext context)
        {
            ...
            manager.UserValidator = new UserValidator<IdentityWithoutEntityFramwork.Service.IdentityUser, Guid>(manager)
            {
